...
export class UserRepositoryService {
  ...
  enroll(classId:string): Observable<any> {
    ...
    this.currentUser = {
      ...this.currentUser, classes: this.currentUser.classes.push(classId)
    };
  ...
  drop(classId:string): Observable<any> {
    ...
    this.currentUser = {
      ...this.currentUser.classes, classes: this.
        currentUser.classes.filter((c: string) => c !== classId)
    };
